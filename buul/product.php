...
<link rel="stylesheet" type="text/css" href="styles/pproduct_responsive.css">
		<!-- Main Navigation -->		
		<!-- Menu -->
					...
					<div class="product_description">
						...
						<div class="order_info d-flex flex-row">
							<form action="#">
								...
								<div class="product_price">Sh2000</div>

								<div class="button_container">
									<button type="button" class="button cart_button"><a href="cart.php">Add to Cart</button>
...
<ul class="nav nav-tabs">
  ...
  <li class="nav-item">
    <a class="nav-link" data-toggle="tab" href="#menu">Product Details</a>
  </li></ul>

<!-- Tab panes -->
<div class="tab-content">
  <div class="tab-pane active container" id="home"><ul><li>One</li><li>two</li><li>three</li></ul></div>
  <div class="tab-pane container" id="menu"><ul><li>WWOne</li><li>two</li><li>three</li></ul></div>
</div></div>
	<!-- Recently Viewed -->
	<!-- Brands -->
